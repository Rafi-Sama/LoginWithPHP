...
<body>
    ...
    <a href="/LoginWithPHP/logout.php" class="bg-red-600 my-auto text-white font-semibold rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 p-5">Logout</a>
